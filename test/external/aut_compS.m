...
cfg.text.instructions_p1 = ['Nesta tarefa ir� ouvir sons. \n\n',...
    'Ser� pedido que fa�a diferentes julgamentos \n',...
    'acerca da autenticidade de sons emocionais, \n',...
    'enquanto em sons neutros pedimos apenas que \n',...
    'preste aten��o. \n\n',...
    'A autenticidade � definida como a propriedade de \n',...
    'genuinidade de uma emo��o, podendo ser classificada \n',...
    'como genu�na (aut�ntica) ou for�ada (n�o aut�ntica).\n\n',...
    'Por favor, responda apenas no fim de cada som, \n',...
    'e efetue a resposta com base na sua primeira impress�o.\n\n',...
    'Pressione a tecla SPACE para come�ar.'];
...
for i = 1:size(cfg.sequences.trialOrder,1)
    ...
    if i == 51 || i == 102 || i == 153
        ...
        % restart the task
        DrawFormattedText(w,'Agora preste aten��o.','center','center');
        Screen('Flip',w);
