clear; close all; clc;
generate_sequences;  % Generate stimuli sequence
...
if exportXlsx
    ...
    writetable(logTable, [results_path '/logfile_session1_' num2str(subID) '.xlsx']);
end
...
if exportTsv
    ...
    writetable(logTable, [results_path '/logfile_session1_' num2str(subID) '.tsv'], 'FileType', 'text', 'Delimiter', '\t');
end
...
writetable(eventTable, [results_path '/eventfile_session1_' num2str(subID) '.xlsx']);
end
...
writetable(eventTable, [results_path '/eventfile_session1_' num2str(subID) '.tsv'], 'FileType', 'text', 'Delimiter', 'tab');
end
